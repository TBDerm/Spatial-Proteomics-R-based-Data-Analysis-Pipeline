...
* Uses the limma R package system7, which fits a linear model and empirical bayes moderation to generate pairwise comparisons. P-values are corrected for multiple comparisons using Benjamini Hochberg.
